  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      <div className="absolute inset-0 md:hidden">
        <Image src="/me-draw-transparent.png" alt="Iván Olivares" fill className="object-contain opacity-10" priority />
      </div>
          ...
          <div className="w-full">
            <div className="flex-1 space-y-8">
              ...
              <div className="flex flex-wrap items-center gap-6 text-muted-foreground">
                <a href="https://www.linkedin.com/in/ivanolivaresrojas/?from=iolivares.com" className="hover:text-foreground transition-colors flex items-center gap-2">
                ...
                <a href="https://x.com/ivolivares/?from=iolivares.com" className="hover:text-foreground transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://instagram.com/ivolivares/?from=iolivares.com" className="hover:text-foreground transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
