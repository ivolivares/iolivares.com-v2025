          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { handle: "@ivolivares", name: "GitHub", url: "https://github.com/ivolivares?from=iolivares.com" },
                  { handle: "@ivolivares", name: "Twitter", url: "https://x.com/ivolivares?from=iolivares.com" },
                  { handle: "@ivolivares", name: "Facebook", url: "https://fb.me/ivolivares?from=iolivares.com" },
                  {
